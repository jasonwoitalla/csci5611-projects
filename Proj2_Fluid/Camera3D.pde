...
class Camera
{
  Camera()
  {
    position      = new PVector(1236, -170, 845); // initial position
    theta         = 1.0610317; // rotation around Y axis. Starts with forward direction as ( 0, 0, -1 )
    phi           = -0.33541167; // rotation around X axis. Starts with up direction as ( 0, 1, 0 )
    moveSpeed     = 50;
