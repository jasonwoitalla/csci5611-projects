...
// TODO:
//  -Try: dx/dx = 2*t*cos(t*t) -> x(t) = sin(t*t) + C
//        dx/dt = 2 -> x(t) = 2*t
//        dx/dt = 2*t -> x(t) = t*t
//        dx/dt = t*t*t -> x(t) = t*t*t*t*0.25
//        dx/dt = x -> x(t) = x*t
//        dx/dt = sin(t) + t*cos(t) -> x(t) = t*sin(t)
...
float actual_x_of_t(float t) {
  return t*sin(t) + 0; // The derivative of this function should be placed in dxdt!
}
